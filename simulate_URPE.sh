...
# Task ETP
task_type='f'
TSB_DIR=../output/task-ETP-URPE/tsb
SAVE_DIR=../output/task-ETP-URPE

python train.py --fp16 $DATA_DIR \
    --task synthetic_task --no-use-position-embeddings --rel-pos --rel-pos-unique --ur-attn --ur-attn-unique --constant-init-ur-attn \
...
# Task PI
task_type='r'
TSB_DIR=../output/task-PI-URPE/tsb
SAVE_DIR=../output/task-PI-URPE
