...
# Task ETP
task_type='f'
TSB_DIR=../output/task-ETP-RPE/tsb
SAVE_DIR=../output/task-ETP-RPE

python train.py --fp16 $DATA_DIR \
    --task synthetic_task --no-use-position-embeddings --rel-pos --rel-pos-unique \
...
# Task PI
task_type='r'
TSB_DIR=../output/task-PI-RPE/tsb
SAVE_DIR=../output/task-PI-RPE
